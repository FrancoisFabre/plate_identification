function X = Katri_Rao(U,varargin)
%KR Khatri-Rao product.
%   Katri_Rao(A,B) returns the Khatri-Rao product of two matrices A and B, of 
...
%   kron(A(:,k),B(:,k)).
%
%   Katri_Rao(A,B,C,...) and Katri_Rao({A B C ...}) compute a string of Khatri-Rao 
